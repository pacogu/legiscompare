// Genera un borrador de sintesis comparada por eje juridico, usando Gemini
// sobre los resultados ya encontrados (titulo, resumen y fecha obtenidos
// por la busqueda con Google Search grounding). Este texto es SIEMPRE un
